...
namespace CryptoMonitor.WPF.ViewModels
{
    ...
    public class CryptoInfoViewModel : ViewModelBase
    {
        ...
        private Timer timer;
        private List<CryptoWidget> _labels;
        public List<CryptoWidget> Labels
        {
            get
            {
                return _labels;
        ...
        {
            Labels = new List<CryptoWidget>();
            _cryptoInfoService = cryptoInfoService;
            _cryptoCurrencyService = cryptoCurrencyService;
            //_cryptoCurrencyService.GetByUserId(1);
            ...
            Labels.Add(new CryptoWidget("BTC"));
            Labels.Add(new CryptoWidget("ETH"));
            Labels.Add(new CryptoWidget("BNB"));
            Labels.Add(new CryptoWidget("USDT"));
            Labels.Add(new CryptoWidget("ADA"));
            Labels.Add(new CryptoWidget("DOT"));
            Labels.Add(new CryptoWidget("XRP"));
            Labels.Add(new CryptoWidget("UNI"));
            Labels.Add(new CryptoWidget("LTC"));
            Labels.Add(new CryptoWidget("LINK"));
